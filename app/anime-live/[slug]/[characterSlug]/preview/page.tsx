...
export default function LiveWallpaperPreviewPage() {
    ...
    if (navigator.share && wallpaper) {
      try {
        await navigator.share({
          ...
          text: "Check out this live wallpaper on Zynx Wallpapers!",
  ...
  if (loading)
    return (
      <main className="min-h-screen flex flex-col items-center justify-center gap-4 px-4">
        ...
        <p className="text-[var(--muted)] text-sm">Loading live wallpaper...</p>
      </main>
    );
  ...
  if (error || !wallpaper)
    return (
      <main className="min-h-screen flex flex-col items-center justify-center gap-6 px-4">
        ...
        <p className="text-[var(--muted)] text-base">{error || "Live wallpaper not found."}</p>
        <button
          onClick={() => router.back()}
      ...
      <div className="flex items-center justify-center min-h-[calc(100vh-64px)] p-4">
        <div className="max-w-5xl w-full bg-[var(--card)] border border-[var(--border)] rounded-xl shadow-xl overflow-hidden">
          ...
          <div className="p-4 sm:p-6 text-center">
            <h1 className="sm:hidden text-xl font-bold text-[var(--accent)] mb-3">
              {wallpaper.title}
            </h1>
        ...
        >
          ...
          >
            ...
            <div className="flex flex-col gap-3">
              {[
                { type: "pc", label: "PC (4K)", icon: "💻" },
                { type: "wallpaper", label: "Desktop Wallpaper (1080p)", icon: "🖥️" },
